...
class CustomEntityFactory {
    ...
    /**
     * Add an entity to the EntityFactory along with all necessary configurations.
     * An optional behavior identifier can be given if you desire your entity to act like a vanilla entity.
